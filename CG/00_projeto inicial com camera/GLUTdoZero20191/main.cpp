...
public:
    ...
    //void mouseControl() {
    //    angY = speed >= 0 ? -glutGUI::ay : glutGUI::ay;
    //    speed = -0.001*glutGUI::ax;
    //}
    float axAnt = 0;
    float ayAnt = 0;
    void mouseControl() {
        float dax = glutGUI::ax - axAnt;
        float day = glutGUI::ay - ayAnt;

        angY += speed >= 0 ? -day : day;
        speed += -0.001*dax;
...
void teclado(unsigned char key, int x, int y) {
    ...
    //    break;
    case 'a':
        carros[sel].angY += carros[sel].speed >= 0 ? 5 : -5;
        break;
    case 'd':
        carros[sel].angY -= carros[sel].speed >= 0 ? 5 : -5;
        break;
